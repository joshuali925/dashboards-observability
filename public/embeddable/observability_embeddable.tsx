...
import { opensearchFilters } from '../../../../src/plugins/data/server';
import {
  Embeddable,
  EmbeddableOutput,
  ErrorEmbeddable,
...
> {
  ...
  private savedVisBuilder?: ObservabilitySavedObjectAttributes;
  private serializedState?: { visualization: string; style: string };
  private uiState?: PersistedState;

  constructor(
    timefilter: TimefilterContract,
    { savedVisBuilder, editPath, editUrl, editable }: ObservabilityEmbeddableConfiguration,
    ...
    super(
      initialInput,
      {
        ...
        editPath,
        editApp: 'dashboards-observability',
        editUrl,
        editable,
        savedVisBuilder,
      },
  ...
  // TODO: we may eventually need to add support for visualizations that use triggers like filter or brush, but current Observability vis types don't support triggers
